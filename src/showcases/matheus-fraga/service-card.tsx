    ...
    <Card className="group overflow-hidden border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
      <CardContent className="p-0">
        <div className="relative h-48 overflow-hidden">
          <div className={`absolute inset-0 bg-linear-to-r ${accentColor} opacity-80 z-10`} />
          <image
          ...
          />
          <div className="absolute top-4 left-4 z-20 bg-white/20 backdrop-blur-xs rounded-full p-2 border border-white/30">
