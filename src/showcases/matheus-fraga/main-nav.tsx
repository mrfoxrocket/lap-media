...
import { cn } from "@/lib/utils"; // Tailwind-style classnames utility
        ...
        return (
          ...
          >
            ...
            {hasChildren && (
              <div
                className={cn(
                  "absolute left-0 top-full pt-2 w-48 opacity-0 translate-y-1 pointer-events-none transition-all duration-200 z-50",
